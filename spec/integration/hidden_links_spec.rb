...
feature 'hidden links' do
	...
	let(:admin) { Factory(:admin_user, :email => 'admin@example.com') }
	...
	context 'regular users' do
		...
		scenario 'New ticket link is shown t oa user with permission' do
		...
		scenario 'Delete ticket link is hidden form a user without permission' do
			define_permission!(user, 'view', project)
			visit project_path(project)
			click_link ticket.title
